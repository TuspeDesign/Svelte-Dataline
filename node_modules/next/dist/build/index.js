...
if(!isDynamic){await moveExportedPage(page,file,true,'json');finalPrerenderRoutes[page]={initialRevalidateSeconds:exportConfig.initialPageRevalidationMap[page],srcRoute:null,dataRoute:_path.default.posix.join('/_next/data',buildId,`${page==='/'?'/index':page}.json`)};}else{// For a dynamic SPR page, we did not copy its html nor data exports.
