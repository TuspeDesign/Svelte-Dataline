...
{loader:require.resolve('postcss-loader'),options:{ident:'postcss',plugins:postCssPlugins,sourceMap:true}}].filter(Boolean),// A global CSS import always has side effects. Webpack will tree
